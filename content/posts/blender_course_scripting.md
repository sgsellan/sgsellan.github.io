...
`bt.readMesh`. For example, let us assume that we have a mesh called `dog.obj` in our directory (I am using an amazing dog mesh designed by [Josh Holinaty](https://holinaty.com)):

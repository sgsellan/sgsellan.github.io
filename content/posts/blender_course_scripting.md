...
`bt.readMesh`. For example, let us assume that we have a mesh called `dog.obj` in our directory (I am using [this](images/blender-tutorial/dog.obj) amazing dog mesh designed by [Josh Holinaty](https://holinaty.com)):

...
Each student has **five** late days, to use at their discretion throughout the course (you do not need to specify a reason for using them, and the TAs will keep track of these). These late days cannot be used for Assignment 8, since the solutions to it will be discussed in class the day after. They also cannot be used for the course's final project, since it will be presented in class by the student.
